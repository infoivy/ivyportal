...
function ConsequenceStep({
  ...
  const toneStyles = {
    warning: { border: "border-l-amber-500", ring: "ring-amber-500/40", badge: "bg-amber-500/15 text-amber-500 border-amber-500/30", num: "bg-amber-500/10 text-amber-500 border-amber-500/30" },
    ...
    critical: { border: "border-l-red-500", ring: "ring-red-500/40", badge: "bg-red-500/15 text-red-500 border-red-500/30", num: "bg-red-500/10 text-red-500 border-red-500/30" },
  }[tone];

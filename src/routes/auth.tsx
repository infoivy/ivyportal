    ...
    <div className="dashboard-dark min-h-screen flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="flex items-center gap-2 mb-6 justify-center">
          ...
          <div>
            <div className="text-xs font-bold tracking-[0.2em] uppercase text-foreground">ISA Team</div>
        ...
        <div className="rounded-md border border-border bg-card p-5 space-y-4">
          <div>
            ...
            <p className="text-[11px] text-muted-foreground uppercase tracking-wider mt-0.5">
              {tab === "signin" ? "Sign in to your dashboard" : "Create your setter account"}
            </p>
          </div>
        ...
        <p className="text-[10px] text-muted-foreground text-center mt-4 uppercase tracking-wider">
          First person to sign up becomes admin · <Link to="/" className="underline hover:text-foreground">Back home</Link>
        </p>
      </div>
    </div>
  );

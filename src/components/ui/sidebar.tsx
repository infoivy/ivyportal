  ...
  (
    ...
    return (
      ...
      >
        ...
        <div
          className={cn(
            "relative w-(--sidebar-width) bg-transparent motion-safe:transition-[width] duration-200 ease-(--ease-out)",
        ...
        <div
          className={cn(
            "fixed inset-y-0 z-10 hidden h-svh w-(--sidebar-width) motion-safe:transition-[left,right,width] duration-200 ease-(--ease-out) md:flex",
            side === "left"
  ...
  ({ className, ...props }, ref) => {
    ...
    return (
      <button
        ...
        className={cn(
          "absolute inset-y-0 z-20 hidden w-4 -translate-x-1/2 motion-safe:transition-[left,right,transform] ease-(--ease-out) after:absolute after:inset-y-0 after:left-1/2 after:w-[2px] hover:after:bg-sidebar-border group-data-[side=left]:-right-4 group-data-[side=right]:left-0 sm:flex",
  ...
  ({ className, children, dir: _dir, ...props }, ref) => {
    return (
      <ScrollArea
        ...
        {...props}
      >
        <div className={cn("flex min-h-0 flex-col gap-2", className)}>{children}</div>
      </ScrollArea>
    );
  },
);
...
>(({ className, asChild = false, ...props }, ref) => {
  ...
  return (
    <Comp
      ...
      className={cn(
        "flex h-8 shrink-0 items-center rounded-md px-2 text-xs font-medium text-sidebar-foreground/70 outline-none ring-sidebar-ring motion-safe:transition-[margin,opacity] duration-200 ease-(--ease-out) focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0",

...
// build (2026-07-28) and merged into the Setting Process page (founder-
// directed 2026-07-29). Content is verbatim; drag works on touch, the exit
// button returns to the workflow view.
...
export function DmMasteryBoard({ onExit }: { onExit: () => void }) {
...
Notes for sales manager:`}
      ...
      <div className="fixed bottom-4 left-1/2 -translate-x-1/2 flex items-center gap-2 bg-card border rounded-lg sop-shadow-elevated px-3 py-2 text-xs">
        ...
        >
          <ArrowLeft className="w-3.5 h-3.5" /> Setting Process
        </button>

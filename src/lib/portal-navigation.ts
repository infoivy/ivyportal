...
export const WORK_NAV_ITEMS: PortalNavItem[] = [
  ...
  },
  {
    ...
    description: "Setter and closer operating records and daily execution.",
    url: "/sales",
    icon: BriefcaseBusiness,
    roles: ["admin", "closer"],
    group: "work",
  },
  {
    key: "deals",
    title: "Deals",
    description: "Log closes and maintain verified deal records.",
    url: "/revenue",
    icon: HandCoins,
  ...
  },
  {
    key: "installments",
    title: "Installments",
    description: "Upcoming, overdue, and collected installment records.",
    url: "/installments",
    icon: ReceiptText,
    roles: ["admin", "founder", "closer", "coach"],
    group: "work",

...
const STUDENTS = [
  ...
  S({ full_name: "Musab Farouk", email: "musab.farouk@isa.demo", phase: "training", grade: "B",
  ...
  S({ full_name: "Layth Abdullah", email: "layth.abdullah@isa.demo", phase: "training", grade: "C",
  ...
  S({ full_name: "Sami Haddad", email: "sami.haddad@isa.demo", phase: "training", grade: "B",
  ...
  S({ full_name: "Faris Al-Amin", email: "faris.alamin@isa.demo", phase: "training", grade: "At Risk",
  ...
  S({ full_name: "Nadir Hassan", email: "nadir.hassan@isa.demo", phase: "training", grade: "B",
  ...
  S({ full_name: "Jibril Sow", email: "jibril.sow@isa.demo", phase: "training", grade: "A",
